...
class TestStripeClient:
    ...
    def test_create_checkout_session(self, mock_stripe):
        ...
        mock_price = MagicMock(
            id="price_1", unit_amount=1490, currency="eur",
        ...
        mock_stripe.checkout.Session.create.return_value = MagicMock(url="https://checkout.stripe.com/xxx")
    ...
    def test_create_portal_session(self, mock_stripe):
        ...
        mock_stripe.billing_portal.Session.create.return_value = MagicMock(url="https://portal.stripe.com/xxx")
...
class TestDatabaseStripeFields:
    ...
    def setup_method(self):
        from server.auth.database import set_admin_db_path, init_admin_db, create_user
    ...
    def test_update_stripe_customer_id(self):
        from server.auth.database import update_stripe_customer_id, get_user_by_id
    ...
    def test_update_stripe_subscription_id(self):
        from server.auth.database import update_stripe_subscription_id, get_user_by_id
    ...
    def test_get_user_by_stripe_customer_id(self):
        from server.auth.database import update_stripe_customer_id, get_user_by_stripe_customer_id
